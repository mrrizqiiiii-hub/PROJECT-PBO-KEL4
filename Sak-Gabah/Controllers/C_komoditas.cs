...
{
    public class C_komoditas : C_baseController, IControllerBaca<M_detailKomoditas>, IControllerTambah<M_komoditas>
    {
        ...
        public List<M_detailKomoditas> ambilDetailKomoditasTransaksi(int idTerpilih)
        {
            ...
            string query =
                ...
                "JOIN detail_komoditas dk USING (id_komoditas) " +
                "JOIN \"user\" u USING (id_user) " +
                "WHERE k.id_komoditas = @idTerpilih; AND stok > 0 AND status_aktif = '1'";
